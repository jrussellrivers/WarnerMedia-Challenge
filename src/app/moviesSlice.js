...
export const fetchMoviesByName = createAsyncThunk('movies/fetchMoviesByName', async (movieName) => {
    ...
    for (let i = 0; i < firstResponse.movie_results.length; i++) {
        let movie = await fetch(`https://movies-tvshows-data-imdb.p.rapidapi.com/?type=get-movie-details&imdb=${firstResponse.movie_results[i].imdb_id}`, {
            "method": "GET",
            "headers": {
                "x-rapidapi-key": "6c47160dd6msh909840b92fd1877p146dfdjsn837a6d851c44",
                "x-rapidapi-host": "movies-tvshows-data-imdb.p.rapidapi.com"
        ...
        let moviePoster = await fetch(`https://movies-tvshows-data-imdb.p.rapidapi.com/?type=get-movies-images-by-imdb&imdb=${firstResponse.movie_results[i].imdb_id}`, {
            "method": "GET",
            "headers": {
                "x-rapidapi-key": "6c47160dd6msh909840b92fd1877p146dfdjsn837a6d851c44",
                "x-rapidapi-host": "movies-tvshows-data-imdb.p.rapidapi.com"
